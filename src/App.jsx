    ...
    return (
        <div className="min-h-screen bg-[#013220] flex items-start justify-center py-12 px-6">
            <div className="w-full max-w-3xl rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.6)] shadow-emerald-950/70 border border-emerald-800 bg-[#671a2a]">
                    ...
                    <div className="bg-zinc-800 rounded-xl p-8 text-center shadow-inner shadow-zinc-700/50">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="relative -mt-8">
                                <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-zinc-700 overflow-hidden ring-4 ring-[#671a2a] ring-offset-4 ring-offset-zinc-800 shadow-xl shadow-[#671a2a]/40">
                                    <img
                                        src={imageSrc}
                                        alt="Profile"
                ...
                <span className="px-5 py-2 bg-[#671a2a] text-white rounded-full font-semibold shadow-md shadow-[#671a2a]/60">
                  {member.membershipType}
                </span>
                                <span className="px-5 py-2 bg-[#013220] text-white rounded-full font-semibold shadow-md shadow-emerald-900/60">
                  Joined: {member.joiningDate}
                    ...
                    <section className="mt-8 bg-zinc-900 rounded-lg p-6 shadow-lg shadow-zinc-800/80">
                        <h3 className="text-2xl font-extrabold text-amber-100 drop-shadow-sm">
                            Personal & Membership Info
                        </h3>
                        <div className="h-1 bg-[#671a2a] mt-4 rounded shadow-md shadow-[#671a2a]/50"></div>
                    ...
                    <footer className="mt-8">
                        <div className="bg-[#013220] text-white py-4 px-6 rounded-md text-center font-semibold text-lg shadow-lg shadow-emerald-950/70">
...
function Row({ label, value }) {
    return (
        <div className="grid grid-cols-3 gap-4 px-6 py-4 items-center hover:bg-zinc-800/70 transition-shadow shadow-sm hover:shadow-md hover:shadow-[#671a2a]/30 rounded">
